    ...
    return (
        <Layout pageTitle={title}>
            <div className="flex flex-col font-sans font-mono text-white m-4 p-4">
                <Image className="object-contain h-80 w-80 self-center" fluid={imageData} alt={title} />
                <div className="flex flex-col">
                    <h2 className="text-3xl sm:text-xl md:text-2xl p-1 font-semibold">{title}</h2>
                    ...
                    <Link className="hover:text-pink-500 text-2xl p-1 pt-2" to={"/projects/"}>
                        Go Back &rarr;
                    </Link>
                </div>
            </div>
